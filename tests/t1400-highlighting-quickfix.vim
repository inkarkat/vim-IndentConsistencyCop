...
call vimtap#Is(getqflist()[0].text, 'Indent conflicts with tab4', 'quickfix text for inconsistent indent')
call vimtap#Is(getqflist()[0].col, 1, 'quickfix column for inconsistent indent')

call vimtap#Is(getqflist()[2].text, 'Bad mix of space and tab', 'quickfix text for badmix')
