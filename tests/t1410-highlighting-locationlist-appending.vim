...
call vimtap#Is(getloclist(0)[0].text, 'Bad mix of space and tab: bar.^Ihere$', 'quickfix text for badmix')
call vimtap#Is(getloclist(0)[0].col, 8, 'quickfix column for badmix')
call vimtap#Is(getloclist(0)[2].text, 'Bad softtabstop: q^I........!$', 'quickfix text for badmix')
